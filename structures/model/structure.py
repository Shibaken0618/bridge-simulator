...
class Structure:
    __DOF_PER_NODE = 2 # since bridge is drawn in 2d, degree of freedom is 2 (xy plane)
    ...
    # from loads, nodes, and bars, a structure is created while also solving the equations
