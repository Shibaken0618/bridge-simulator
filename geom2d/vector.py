...
####################################
# class to create vector in 2d plane
####################################
...
class Vector:
    ...
    # return u, v, and normal components of vector as a string
    def __str__(self):
        return f'({self.u}, {self.v}) with norm {self.norm}'

    # formats vector string into specified decimal points
